...
public class VehicleControl : MonoBehaviour
{
    ...
    {
        public bool frontWheelDrive = true;//前驱？前面的两个轮子是否转动
        public Transform frontRight;//右前方
        public Transform frontLeft;//左前方

        public bool backWheelDrive = true;//后驱？后见面的两个轮子是否转动
        public Transform backRight;//右后方
        public Transform backLeft;//左后方
    }

    [System.Serializable]
    public class WheelSetting//车轮设置
    {
        public float Radius = 0.4f;//半径
        public float Weight = 1000.0f;//重量
        public float Distance = 0.2f;//距离
    }


    // Lights Setting ////////////////////////////////

    public CarLights carLights;//车灯
